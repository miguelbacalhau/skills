...
Do not ask questions and do not commit. Apply the spec's Doubt Rule to local ambiguity. Return implemented changes, verification results, deviations, guesses, and exact blockers.
