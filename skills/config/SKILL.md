...
- This skill configures the reviewer choice and models/effort only. The codex machine setup (binary, auth, MCP timeout) belongs to orca:doctor; repository layout belongs to orca:init; run behavior belongs to orca:run.
